package foundation.privacybydesign.email.redis;
...
public class Redis {
     ...
     * some information needs to be added to the key in order to prevent duplicate
     * keys.
     * In this case we add the prefix for this component (e.g. sms-issuer) and then
     * a namespace for the different types inside this component (e.g. the token
     * requests).
     * They will be formatted in the following format:
    ...
    /**
     * Creates a connection to a sentinel Redis using credentials loaded from
